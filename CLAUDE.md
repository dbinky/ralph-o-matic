...
For deeper guidance, review relevant files in `docs/reference` before non-trivial changes:
...
- `animation_standards.md` - **REQUIRED** for any animation work (state machines, telemetry, testing)

## Thinking and Model Requirements

**Always use extended thinking.** Knowing everything you know, before responding to any non-trivial question or
performing any task involving code changes, reasoning about architecture, debugging,
or planning, you MUST engage extended thinking. Default to thinking through problems
